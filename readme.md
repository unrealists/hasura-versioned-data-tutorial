...
Here is a gif for you. Hasura Console is enough to create this table without any direct access to our belived DB.

![](./3.gif)

_note: default value for `deleted` field can be either `null` or `false`. It doesn't matter_
...
### 4- Final notes before we go and try out our powerfull new API.
